...
<div class="container-fluid">
 <div style="width: 45%;height: 650px;float: left;background-color: grey">
  ...
  <div style="width: 100%;height: 300px;">
    <form action="/kidssummercamp/Login" method="post">
     
      <div class="form-group">
        <label style="margin-left:30px" for="email"><h6>UserId:</h6></label>
        <input style="width:500px;margin-left:30px" class="form-control" type="text" name="userid" id="userid" placeholder="example@gmail.com" required="required" />
      </div>
      <div class="form-group">
        <label style="margin-left:30px" for="password"><h6>Password:</h6></label>
        <input  style="width:500px;margin-left:30px" class="form-control" type="password" name="userpass" id="userpass" placeholder="********" required="required" />
      </div>
      <div class="m-t-lg">
